...
import filters from './filters.jpg';
import doNothingWin from './do_nothing_win.jpg';
...
<Image class="mx-auto h-80 w-auto" src={filters} alt="The Instagram filter picker, circa 2011" />
...
Once I'm in, the strategy is simple: <a href={doNothingWin.src}>do nothing</a>. I don't click "Next." I don't swipe. Every interaction generates telemetry: mouse movements, click timing, scroll patterns. Instagram watches for that stuff.
