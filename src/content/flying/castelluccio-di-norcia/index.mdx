...
pubDate: 2025-05-04
description: "Four days on the Piani di Castelluccio with the NoName Fly Zone crew, one flyable afternoon, and my first thermal."
cover: ./cover.jpg
---
...
<Image class="post-cover" src={van} alt="The green Volkswagen T3 parked on a gravel lot" />
...
<Carousel images={[photo3, photo2, photo1]} label="Photos from the Piani di Castelluccio" />
...
<IgcViewer client:visible track={track} label="Castelluccio di Norcia flight replay" />
